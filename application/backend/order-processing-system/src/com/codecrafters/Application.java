...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println(customerLoginService.login("John Doe", 123456));
...
//        }
        ...
        System.out.println(orderServiceEmp.fetchInvoice(2));
//        System.out.println(orderService.fetchAllOrders());

//        try {
//            System.out.println(orderService.fetchInvoice(2));
...
//                1000.00, 50.0);
        ...
        System.out.println(orderServiceCustomer.fetchPendingOrders(1));

        // approve order ->
        // orderId will be required
        orderServiceCustomer.approveOrder(2);
